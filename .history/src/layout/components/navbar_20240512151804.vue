  ...
  <div class="app flex-between-center p-x-10">
    <div class="flex-center-center">
      <div
        ...
        @click="proxy.$stores.settings.useSettingsStore().update"
      >
        <el-icon :size="22">
          <component
            :is="proxy.$stores.settings.useSettingsStore().isShowMenu ? 'Fold' : 'Expand'"
          />
        </el-icon>
      </div>
...
let useUserStore = proxy.$stores.user.useUserStore()
